    ...
    <div class="d-none d-lg-block position-relative bg-primary h-50px">
        <div class="container h-100">
            <div class="d-flex h-100">
                ...
                <div class=" aiz-category-menu  ml-xl-4 w-100 overflow-hidden" id="category-sidebar">
                    <div class="d-flex align-items-center justify-content-center justify-content-xl-start h-100">
                        <ul class="list-unstyled categories no-scrollbar mb-0 text-left">
                            @foreach (get_level_zero_categories()->take(10) as $key => $category)
                                ...
                                @endphp
                                <li class="category-nav-element  border-top-0 list-inline-item mr-0 animate-underline-white" data-id="{{ $category->id }}">
                                    <a href="{{ route('products.category', $category->slug) }}"
                                       class="fs-13 px-3 py-3 d-inline-block fw-700 header_menu_links hov-bg-black-10 {{$nav_txt_color}}
