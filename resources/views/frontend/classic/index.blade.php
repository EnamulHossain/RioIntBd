        ...
        <section class="mt-2 mt-md-3">
            <div class="container">
                ...
                <div class="d-flex justify-content-center flex-wrap gap-4">
                    @foreach ($featured_categories->take(8) as $key => $category)
                        @php
                            $category_name = $category->getTranslation('name');
                            $category_icon = isset($category->bannerImage->file_name) ? my_asset($category->bannerImage->file_name) : static_asset('assets/img/placeholder.jpg');
                            $gradient_background = "linear-gradient(135deg, #8f8ef1, #e4d6fa)";
                        @endphp
